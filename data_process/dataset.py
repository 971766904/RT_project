...
def make_generator_from_directory(file_path: str):
    ...
    conv = tfio.IODataset.from_hdf5(file_path, '/data/conv', spec=tf.float32, name='conv')
    label = tfio.IODataset.from_hdf5(file_path, '/data/label_1', spec=tf.float32, name='label_1')
